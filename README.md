...
What you need to run the project:
    you need to install mysql, pycharm or visual studio code and android studio.
## 🚀[Getting Started](#getting-started)
```code
git clone https://github.com/MTBMM/AlumniSocial.git
open cmd project
cd alumnisocialnetworkapp then python manage.py migrate
